...
// 
// Generated using ACDS version 14.0 200 at 2015.04.16.08:29:31
...
module final_project_soc_mm_interconnect_0 (
	...
	wire    [6:0] rsp_mux_src_channel;                                                                // rsp_mux:src_channel -> nios2_qsys_0_instruction_master_agent:rp_channel
	...
	wire    [6:0] rsp_mux_001_src_channel;                                                            // rsp_mux_001:src_channel -> nios2_qsys_0_data_master_agent:rp_channel
	...
	wire    [6:0] cmd_mux_src_channel;                                                                // cmd_mux:src_channel -> nios2_qsys_0_jtag_debug_module_agent:cp_channel
	...
	wire    [6:0] cmd_mux_001_src_channel;                                                            // cmd_mux_001:src_channel -> onchip_memory2_0_s1_agent:cp_channel
	...
	wire          cmd_mux_002_src_endofpacket;                                                        // cmd_mux_002:src_endofpacket -> sdram_s1_agent:cp_endofpacket
	wire          cmd_mux_002_src_valid;                                                              // cmd_mux_002:src_valid -> sdram_s1_agent:cp_valid
	wire          cmd_mux_002_src_startofpacket;                                                      // cmd_mux_002:src_startofpacket -> sdram_s1_agent:cp_startofpacket
	wire  [104:0] cmd_mux_002_src_data;                                                               // cmd_mux_002:src_data -> sdram_s1_agent:cp_data
	wire    [6:0] cmd_mux_002_src_channel;                                                            // cmd_mux_002:src_channel -> sdram_s1_agent:cp_channel
	wire          cmd_mux_002_src_ready;                                                              // sdram_s1_agent:cp_ready -> cmd_mux_002:src_ready
	...
	wire  [104:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> sdram_pll_pll_slave_agent:cp_data
	wire    [6:0] cmd_mux_003_src_channel;                                                            // cmd_mux_003:src_channel -> sdram_pll_pll_slave_agent:cp_channel
	...
	wire  [104:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> sysid_qsys_0_control_slave_agent:cp_data
	wire    [6:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> sysid_qsys_0_control_slave_agent:cp_channel
	...
	wire  [105:0] ledg_s1_agent_rf_source_data;                                                       // LEDG_s1_agent:rf_source_data -> LEDG_s1_agent_rsp_fifo:in_data
	...
	wire  [105:0] ledg_s1_agent_rsp_fifo_out_data;                                                    // LEDG_s1_agent_rsp_fifo:out_data -> LEDG_s1_agent:rf_sink_data
	...
	wire          cmd_mux_005_src_endofpacket;                                                        // cmd_mux_005:src_endofpacket -> LEDG_s1_agent:cp_endofpacket
	wire          cmd_mux_005_src_valid;                                                              // cmd_mux_005:src_valid -> LEDG_s1_agent:cp_valid
	wire          cmd_mux_005_src_startofpacket;                                                      // cmd_mux_005:src_startofpacket -> LEDG_s1_agent:cp_startofpacket
	wire  [104:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> LEDG_s1_agent:cp_data
	wire    [6:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> LEDG_s1_agent:cp_channel
	wire          cmd_mux_005_src_ready;                                                              // LEDG_s1_agent:cp_ready -> cmd_mux_005:src_ready
	...
	wire  [105:0] ledr_s1_agent_rf_source_data;                                                       // LEDR_s1_agent:rf_source_data -> LEDR_s1_agent_rsp_fifo:in_data
	...
	wire  [105:0] ledr_s1_agent_rsp_fifo_out_data;                                                    // LEDR_s1_agent_rsp_fifo:out_data -> LEDR_s1_agent:rf_sink_data
	...
	wire  [104:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> LEDR_s1_agent:cp_data
	wire    [6:0] cmd_mux_006_src_channel;                                                            // cmd_mux_006:src_channel -> LEDR_s1_agent:cp_channel
	...
	wire  [104:0] sdram_s1_agent_rp_data;                                                             // sdram_s1_agent:rp_data -> router_004:sink_data
	...
	wire  [104:0] sdram_pll_pll_slave_agent_rp_data;                                                  // sdram_pll_pll_slave_agent:rp_data -> router_005:sink_data
	...
	wire  [104:0] sysid_qsys_0_control_slave_agent_rp_data;                                           // sysid_qsys_0_control_slave_agent:rp_data -> router_006:sink_data
	...
	wire          ledg_s1_agent_rp_endofpacket;                                                       // LEDG_s1_agent:rp_endofpacket -> router_007:sink_endofpacket
	wire          ledg_s1_agent_rp_valid;                                                             // LEDG_s1_agent:rp_valid -> router_007:sink_valid
	wire          ledg_s1_agent_rp_startofpacket;                                                     // LEDG_s1_agent:rp_startofpacket -> router_007:sink_startofpacket
	wire  [104:0] ledg_s1_agent_rp_data;                                                              // LEDG_s1_agent:rp_data -> router_007:sink_data
	wire          ledg_s1_agent_rp_ready;                                                             // router_007:sink_ready -> LEDG_s1_agent:rp_ready
	...
	wire  [104:0] ledr_s1_agent_rp_data;                                                              // LEDR_s1_agent:rp_data -> router_008:sink_data
	...
	wire  [104:0] cmd_demux_001_src2_data;                                                            // cmd_demux_001:src2_data -> crosser_001:in_data
	...
	wire  [104:0] crosser_001_out_data;                                                               // crosser_001:out_data -> cmd_mux_002:sink1_data
	...
	wire  [104:0] rsp_demux_002_src0_data;                                                            // rsp_demux_002:src0_data -> crosser_002:in_data
	...
	wire  [104:0] crosser_002_out_data;                                                               // crosser_002:out_data -> rsp_mux:sink2_data
	...
	wire  [104:0] rsp_demux_002_src1_data;                                                            // rsp_demux_002:src1_data -> crosser_003:in_data
	...
	wire  [104:0] crosser_003_out_data;                                                               // crosser_003:out_data -> rsp_mux_001:sink2_data
	...
	final_project_soc_mm_interconnect_0_router_007 router_008 (
	...
	final_project_soc_mm_interconnect_0_cmd_mux_005 cmd_mux_005 (
		.clk                 (clk_0_clk_clk),                                    //       clk.clk
		.reset               (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	final_project_soc_mm_interconnect_0_cmd_mux_005 cmd_mux_006 (
		.clk                 (clk_0_clk_clk),                                    //       clk.clk
		.reset               (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	final_project_soc_mm_interconnect_0_rsp_demux_005 rsp_demux_005 (
		.clk                (clk_0_clk_clk),                                    //       clk.clk
		.reset              (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	final_project_soc_mm_interconnect_0_rsp_demux_005 rsp_demux_006 (
		.clk                (clk_0_clk_clk),                                    //       clk.clk
		.reset              (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
