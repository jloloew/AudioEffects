...
// 
// Generated using ACDS version 14.1 190 at 2015.05.01.22:28:44
...
module final_project_soc_mm_interconnect_0 (
	...
	wire  [106:0] cmd_mux_007_src_data;                                                               // cmd_mux_007:src_data -> LEDR_s1_agent:cp_data
	wire          cmd_mux_007_src_ready;                                                              // LEDR_s1_agent:cp_ready -> cmd_mux_007:src_ready
	wire    [9:0] cmd_mux_007_src_channel;                                                            // cmd_mux_007:src_channel -> LEDR_s1_agent:cp_channel
	...
	wire  [106:0] cmd_mux_008_src_data;                                                               // cmd_mux_008:src_data -> LEDG_s1_agent:cp_data
	wire          cmd_mux_008_src_ready;                                                              // LEDG_s1_agent:cp_ready -> cmd_mux_008:src_ready
	wire    [9:0] cmd_mux_008_src_channel;                                                            // cmd_mux_008:src_channel -> LEDG_s1_agent:cp_channel
	...
	wire    [9:0] cmd_mux_009_src_channel;                                                            // cmd_mux_009:src_channel -> onchip_memory2_0_s1_agent:cp_channel
	...
	wire  [106:0] ledr_s1_agent_rp_data;                                                              // LEDR_s1_agent:rp_data -> router_009:sink_data
	...
	wire  [106:0] ledg_s1_agent_rp_data;                                                              // LEDG_s1_agent:rp_data -> router_010:sink_data
	...
	wire  [106:0] onchip_memory2_0_s1_agent_rp_data;                                                  // onchip_memory2_0_s1_agent:rp_data -> router_011:sink_data
	...
	wire  [106:0] cmd_demux_001_src6_data;                                                            // cmd_demux_001:src6_data -> cmd_mux_009:sink1_data
	wire          cmd_demux_001_src6_ready;                                                           // cmd_mux_009:sink1_ready -> cmd_demux_001:src6_ready
	wire    [9:0] cmd_demux_001_src6_channel;                                                         // cmd_demux_001:src6_channel -> cmd_mux_009:sink1_channel
	...
	wire  [106:0] rsp_demux_009_src1_data;                                                            // rsp_demux_009:src1_data -> rsp_mux_001:sink6_data
	wire          rsp_demux_009_src1_ready;                                                           // rsp_mux_001:sink6_ready -> rsp_demux_009:src1_ready
	wire    [9:0] rsp_demux_009_src1_channel;                                                         // rsp_demux_009:src1_channel -> rsp_mux_001:sink6_channel
	...
	wire  [106:0] cmd_demux_src6_data;                                                                // cmd_demux:src6_data -> crosser_001:in_data
	wire          cmd_demux_src6_ready;                                                               // crosser_001:in_ready -> cmd_demux:src6_ready
	wire    [9:0] cmd_demux_src6_channel;                                                             // cmd_demux:src6_channel -> crosser_001:in_channel
	...
	wire  [106:0] crosser_001_out_data;                                                               // crosser_001:out_data -> cmd_mux_006:sink0_data
	wire          crosser_001_out_ready;                                                              // cmd_mux_006:sink0_ready -> crosser_001:out_ready
	wire    [9:0] crosser_001_out_channel;                                                            // crosser_001:out_channel -> cmd_mux_006:sink0_channel
	...
	wire  [106:0] cmd_demux_001_src5_data;                                                            // cmd_demux_001:src5_data -> crosser_003:in_data
	...
	wire  [106:0] crosser_003_out_data;                                                               // crosser_003:out_data -> cmd_mux_006:sink1_data
	wire          crosser_003_out_ready;                                                              // cmd_mux_006:sink1_ready -> crosser_003:out_ready
	wire    [9:0] crosser_003_out_channel;                                                            // crosser_003:out_channel -> cmd_mux_006:sink1_channel
	...
	wire  [106:0] rsp_demux_006_src0_data;                                                            // rsp_demux_006:src0_data -> crosser_006:in_data
	wire          rsp_demux_006_src0_ready;                                                           // crosser_006:in_ready -> rsp_demux_006:src0_ready
	wire    [9:0] rsp_demux_006_src0_channel;                                                         // rsp_demux_006:src0_channel -> crosser_006:in_channel
	...
	wire  [106:0] crosser_006_out_data;                                                               // crosser_006:out_data -> rsp_mux:sink6_data
	wire          crosser_006_out_ready;                                                              // rsp_mux:sink6_ready -> crosser_006:out_ready
	wire    [9:0] crosser_006_out_channel;                                                            // crosser_006:out_channel -> rsp_mux:sink6_channel
	...
	wire  [106:0] rsp_demux_006_src1_data;                                                            // rsp_demux_006:src1_data -> crosser_007:in_data
	wire          rsp_demux_006_src1_ready;                                                           // crosser_007:in_ready -> rsp_demux_006:src1_ready
	wire    [9:0] rsp_demux_006_src1_channel;                                                         // rsp_demux_006:src1_channel -> crosser_007:in_channel
	...
	wire  [106:0] crosser_007_out_data;                                                               // crosser_007:out_data -> rsp_mux_001:sink5_data
