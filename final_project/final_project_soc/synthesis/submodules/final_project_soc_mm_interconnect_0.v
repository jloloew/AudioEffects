...
// 
// Generated using ACDS version 14.1 190 at 2015.05.02.17:56:28
...
module final_project_soc_mm_interconnect_0 (
	...
	wire  [106:0] cmd_demux_001_src4_data;                                                            // cmd_demux_001:src4_data -> cmd_mux_009:sink1_data
	wire          cmd_demux_001_src4_ready;                                                           // cmd_mux_009:sink1_ready -> cmd_demux_001:src4_ready
	wire    [9:0] cmd_demux_001_src4_channel;                                                         // cmd_demux_001:src4_channel -> cmd_mux_009:sink1_channel
	...
	wire  [106:0] rsp_demux_009_src1_data;                                                            // rsp_demux_009:src1_data -> rsp_mux_001:sink4_data
	wire          rsp_demux_009_src1_ready;                                                           // rsp_mux_001:sink4_ready -> rsp_demux_009:src1_ready
	wire    [9:0] rsp_demux_009_src1_channel;                                                         // rsp_demux_009:src1_channel -> rsp_mux_001:sink4_channel
	...
	wire  [106:0] crosser_002_out_data;                                                               // crosser_002:out_data -> cmd_mux_006:sink1_data
	wire          crosser_002_out_ready;                                                              // cmd_mux_006:sink1_ready -> crosser_002:out_ready
	wire    [9:0] crosser_002_out_channel;                                                            // crosser_002:out_channel -> cmd_mux_006:sink1_channel
	...
	wire    [9:0] rsp_demux_src0_channel;                                                             // rsp_demux:src0_channel -> crosser_003:in_channel
	...
	wire    [9:0] crosser_003_out_channel;                                                            // crosser_003:out_channel -> rsp_mux:sink0_channel
	...
	wire  [106:0] rsp_demux_006_src0_data;                                                            // rsp_demux_006:src0_data -> crosser_004:in_data
	wire          rsp_demux_006_src0_ready;                                                           // crosser_004:in_ready -> rsp_demux_006:src0_ready
	wire    [9:0] rsp_demux_006_src0_channel;                                                         // rsp_demux_006:src0_channel -> crosser_004:in_channel
	...
	wire  [106:0] crosser_004_out_data;                                                               // crosser_004:out_data -> rsp_mux:sink6_data
	wire          crosser_004_out_ready;                                                              // rsp_mux:sink6_ready -> crosser_004:out_ready
	wire    [9:0] crosser_004_out_channel;                                                            // crosser_004:out_channel -> rsp_mux:sink6_channel
	...
	wire  [106:0] rsp_demux_006_src1_data;                                                            // rsp_demux_006:src1_data -> crosser_005:in_data
	wire          rsp_demux_006_src1_ready;                                                           // crosser_005:in_ready -> rsp_demux_006:src1_ready
	wire    [9:0] rsp_demux_006_src1_channel;                                                         // rsp_demux_006:src1_channel -> crosser_005:in_channel
	...
	final_project_soc_mm_interconnect_0_router_005 router_005 (
	...
	final_project_soc_mm_interconnect_0_router_005 router_006 (
	...
	final_project_soc_mm_interconnect_0_router_005 router_007 (
	...
	final_project_soc_mm_interconnect_0_router_005 router_008 (
	...
	final_project_soc_mm_interconnect_0_router_005 router_011 (
	...
	final_project_soc_mm_interconnect_0_cmd_mux_003 cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_qsys_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	final_project_soc_mm_interconnect_0_cmd_mux_003 cmd_mux_004 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_qsys_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	final_project_soc_mm_interconnect_0_cmd_mux_003 cmd_mux_005 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_qsys_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	final_project_soc_mm_interconnect_0_cmd_mux_003 cmd_mux_006 (
		.clk                 (sdram_pll_c0_clk),                        //       clk.clk
		.reset               (sdram_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	final_project_soc_mm_interconnect_0_cmd_mux_003 cmd_mux_009 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_qsys_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	final_project_soc_mm_interconnect_0_rsp_demux_003 rsp_demux_003 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_qsys_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	final_project_soc_mm_interconnect_0_rsp_demux_003 rsp_demux_004 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_qsys_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	final_project_soc_mm_interconnect_0_rsp_demux_003 rsp_demux_005 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_qsys_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	final_project_soc_mm_interconnect_0_rsp_demux_003 rsp_demux_006 (
		.clk                (sdram_pll_c0_clk),                        //       clk.clk
		.reset              (sdram_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	final_project_soc_mm_interconnect_0_rsp_demux_001 rsp_demux_007 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_qsys_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	final_project_soc_mm_interconnect_0_rsp_demux_001 rsp_demux_008 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_qsys_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	final_project_soc_mm_interconnect_0_rsp_demux_003 rsp_demux_009 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_qsys_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
