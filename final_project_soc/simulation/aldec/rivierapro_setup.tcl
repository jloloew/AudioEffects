...
alias com {
  ...
  vlog  "$QSYS_SIMDIR/submodules/final_project_soc_mm_interconnect_0_rsp_demux_007.sv"     -work rsp_demux_007                          
  vlog  "$QSYS_SIMDIR/submodules/final_project_soc_mm_interconnect_0_rsp_demux.sv"         -work rsp_demux                              
  vlog  "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                              -work cmd_mux_007                            
  vlog  "$QSYS_SIMDIR/submodules/final_project_soc_mm_interconnect_0_cmd_mux_007.sv"       -work cmd_mux_007                            
  ...
  vlog  "$QSYS_SIMDIR/submodules/final_project_soc_mm_interconnect_0_router_009.sv"        -work router_009                             
  ...
  vlog  "$QSYS_SIMDIR/submodules/altera_merlin_master_agent.sv"                            -work nios2_qsys_0_data_master_agent         
  vlog  "$QSYS_SIMDIR/submodules/altera_merlin_slave_translator.sv"                        -work audio_avalon_audio_slave_translator    
  vlog  "$QSYS_SIMDIR/submodules/altera_merlin_master_translator.sv"                       -work nios2_qsys_0_data_master_translator    
