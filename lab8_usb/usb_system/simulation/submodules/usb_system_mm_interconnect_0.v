...
// 
// Generated using ACDS version 14.1 190 at 2015.05.06.19:03:51
...
module usb_system_mm_interconnect_0 (
	...
	wire    [9:0] cmd_mux_003_src_channel;                                                   // cmd_mux_003:src_channel -> clocks_pll_slave_agent:cp_channel
	...
	wire    [9:0] cmd_mux_004_src_channel;                                                   // cmd_mux_004:src_channel -> clock_crossing_io_s0_agent:cp_channel
	...
	wire    [9:0] cmd_mux_005_src_channel;                                                   // cmd_mux_005:src_channel -> keycode_s1_agent:cp_channel
	...
	wire    [9:0] cmd_mux_006_src_channel;                                                   // cmd_mux_006:src_channel -> sdram_s1_agent:cp_channel
	...
	wire  [106:0] cmd_mux_007_src_data;                                                      // cmd_mux_007:src_data -> led_s1_agent:cp_data
	...
	wire          cmd_mux_008_src_valid;                                                     // cmd_mux_008:src_valid -> all_switches_s1_agent:cp_valid
	wire  [106:0] cmd_mux_008_src_data;                                                      // cmd_mux_008:src_data -> all_switches_s1_agent:cp_data
	wire          cmd_mux_008_src_ready;                                                     // all_switches_s1_agent:cp_ready -> cmd_mux_008:src_ready
	wire    [9:0] cmd_mux_008_src_channel;                                                   // cmd_mux_008:src_channel -> all_switches_s1_agent:cp_channel
	wire          cmd_mux_008_src_startofpacket;                                             // cmd_mux_008:src_startofpacket -> all_switches_s1_agent:cp_startofpacket
	wire          cmd_mux_008_src_endofpacket;                                               // cmd_mux_008:src_endofpacket -> all_switches_s1_agent:cp_endofpacket
	...
	wire          cmd_mux_009_src_valid;                                                     // cmd_mux_009:src_valid -> red_leds_s1_agent:cp_valid
	wire  [106:0] cmd_mux_009_src_data;                                                      // cmd_mux_009:src_data -> red_leds_s1_agent:cp_data
	wire          cmd_mux_009_src_ready;                                                     // red_leds_s1_agent:cp_ready -> cmd_mux_009:src_ready
	wire    [9:0] cmd_mux_009_src_channel;                                                   // cmd_mux_009:src_channel -> red_leds_s1_agent:cp_channel
	wire          cmd_mux_009_src_startofpacket;                                             // cmd_mux_009:src_startofpacket -> red_leds_s1_agent:cp_startofpacket
	wire          cmd_mux_009_src_endofpacket;                                               // cmd_mux_009:src_endofpacket -> red_leds_s1_agent:cp_endofpacket
	...
	wire  [106:0] led_s1_agent_rp_data;                                                      // led_s1_agent:rp_data -> router_009:sink_data
	...
	wire          all_switches_s1_agent_rp_valid;                                            // all_switches_s1_agent:rp_valid -> router_010:sink_valid
	wire  [106:0] all_switches_s1_agent_rp_data;                                             // all_switches_s1_agent:rp_data -> router_010:sink_data
	wire          all_switches_s1_agent_rp_ready;                                            // router_010:sink_ready -> all_switches_s1_agent:rp_ready
	wire          all_switches_s1_agent_rp_startofpacket;                                    // all_switches_s1_agent:rp_startofpacket -> router_010:sink_startofpacket
	wire          all_switches_s1_agent_rp_endofpacket;                                      // all_switches_s1_agent:rp_endofpacket -> router_010:sink_endofpacket
	...
	wire  [106:0] red_leds_s1_agent_rp_data;                                                 // red_leds_s1_agent:rp_data -> router_011:sink_data
	...
	wire    [9:0] cmd_demux_001_src2_channel;                                                // cmd_demux_001:src2_channel -> cmd_mux_003:sink1_channel
	...
	wire    [9:0] rsp_demux_003_src1_channel;                                                // rsp_demux_003:src1_channel -> rsp_mux_001:sink2_channel
	...
	wire    [9:0] crosser_001_out_channel;                                                   // crosser_001:out_channel -> cmd_mux_006:sink1_channel
	...
	wire    [9:0] rsp_demux_006_src0_channel;                                                // rsp_demux_006:src0_channel -> crosser_002:in_channel
	...
	wire    [9:0] crosser_002_out_channel;                                                   // crosser_002:out_channel -> rsp_mux:sink6_channel
	...
	wire    [9:0] rsp_demux_006_src1_channel;                                                // rsp_demux_006:src1_channel -> crosser_003:in_channel
