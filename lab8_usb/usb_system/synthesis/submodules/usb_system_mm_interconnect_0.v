...
// 
// Generated using ACDS version 14.1 190 at 2015.05.03.15:00:16
...
module usb_system_mm_interconnect_0 (
	...
	wire  [104:0] cmd_mux_001_src_data;                                                      // cmd_mux_001:src_data -> cpu_debug_mem_slave_agent:cp_data
	wire          cmd_mux_001_src_ready;                                                     // cpu_debug_mem_slave_agent:cp_ready -> cmd_mux_001:src_ready
	wire    [5:0] cmd_mux_001_src_channel;                                                   // cmd_mux_001:src_channel -> cpu_debug_mem_slave_agent:cp_channel
	...
	wire          cmd_mux_003_src_valid;                                                     // cmd_mux_003:src_valid -> clock_crossing_io_s0_agent:cp_valid
	wire  [104:0] cmd_mux_003_src_data;                                                      // cmd_mux_003:src_data -> clock_crossing_io_s0_agent:cp_data
	wire          cmd_mux_003_src_ready;                                                     // clock_crossing_io_s0_agent:cp_ready -> cmd_mux_003:src_ready
	wire    [5:0] cmd_mux_003_src_channel;                                                   // cmd_mux_003:src_channel -> clock_crossing_io_s0_agent:cp_channel
	wire          cmd_mux_003_src_startofpacket;                                             // cmd_mux_003:src_startofpacket -> clock_crossing_io_s0_agent:cp_startofpacket
	wire          cmd_mux_003_src_endofpacket;                                               // cmd_mux_003:src_endofpacket -> clock_crossing_io_s0_agent:cp_endofpacket
	...
	wire          cmd_mux_004_src_valid;                                                     // cmd_mux_004:src_valid -> keycode_s1_agent:cp_valid
	wire  [104:0] cmd_mux_004_src_data;                                                      // cmd_mux_004:src_data -> keycode_s1_agent:cp_data
	wire          cmd_mux_004_src_ready;                                                     // keycode_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire    [5:0] cmd_mux_004_src_channel;                                                   // cmd_mux_004:src_channel -> keycode_s1_agent:cp_channel
	wire          cmd_mux_004_src_startofpacket;                                             // cmd_mux_004:src_startofpacket -> keycode_s1_agent:cp_startofpacket
	wire          cmd_mux_004_src_endofpacket;                                               // cmd_mux_004:src_endofpacket -> keycode_s1_agent:cp_endofpacket
	...
	wire  [104:0] cpu_debug_mem_slave_agent_rp_data;                                         // cpu_debug_mem_slave_agent:rp_data -> router_003:sink_data
	...
	wire          clock_crossing_io_s0_agent_rp_valid;                                       // clock_crossing_io_s0_agent:rp_valid -> router_005:sink_valid
	wire  [104:0] clock_crossing_io_s0_agent_rp_data;                                        // clock_crossing_io_s0_agent:rp_data -> router_005:sink_data
	wire          clock_crossing_io_s0_agent_rp_ready;                                       // router_005:sink_ready -> clock_crossing_io_s0_agent:rp_ready
	wire          clock_crossing_io_s0_agent_rp_startofpacket;                               // clock_crossing_io_s0_agent:rp_startofpacket -> router_005:sink_startofpacket
	wire          clock_crossing_io_s0_agent_rp_endofpacket;                                 // clock_crossing_io_s0_agent:rp_endofpacket -> router_005:sink_endofpacket
	...
	wire          keycode_s1_agent_rp_valid;                                                 // keycode_s1_agent:rp_valid -> router_006:sink_valid
	wire  [104:0] keycode_s1_agent_rp_data;                                                  // keycode_s1_agent:rp_data -> router_006:sink_data
	wire          keycode_s1_agent_rp_ready;                                                 // router_006:sink_ready -> keycode_s1_agent:rp_ready
	wire          keycode_s1_agent_rp_startofpacket;                                         // keycode_s1_agent:rp_startofpacket -> router_006:sink_startofpacket
	wire          keycode_s1_agent_rp_endofpacket;                                           // keycode_s1_agent:rp_endofpacket -> router_006:sink_endofpacket
	...
	wire    [5:0] cmd_demux_001_src2_channel;                                                // cmd_demux_001:src2_channel -> crosser_001:in_channel
	...
	wire    [5:0] crosser_003_out_channel;                                                   // crosser_003:out_channel -> rsp_mux_001:sink2_channel
	...
	usb_system_mm_interconnect_0_router_002 router_005 (
	...
	usb_system_mm_interconnect_0_router_003 router_007 (
	...
	usb_system_mm_interconnect_0_cmd_mux cmd_mux_003 (
		.clk                 (clk_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	usb_system_mm_interconnect_0_cmd_mux_001 cmd_mux_005 (
		.clk                 (clocks_c0_clk),                           //       clk.clk
		.reset               (sdram_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	usb_system_mm_interconnect_0_rsp_demux rsp_demux_003 (
		.clk                (clk_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	usb_system_mm_interconnect_0_rsp_demux_001 rsp_demux_005 (
		.clk                (clocks_c0_clk),                           //       clk.clk
		.reset              (sdram_reset_reset_bridge_in_reset_reset), // clk_reset.reset
