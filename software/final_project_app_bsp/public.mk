...
# setting SOPC_SYSID_BASE_ADDRESS is 0x68
SOPC_SYSID_FLAG += --sidp=0x68
ELF_PATCH_FLAG  += --sidp 0x68

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1429801432
SOPC_SYSID_FLAG += --timestamp=1429801432
ELF_PATCH_FLAG  += --timestamp 1429801432
